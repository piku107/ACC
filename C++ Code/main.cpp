// Main Program by Snehashis Paul
//Scholarly Paper Project for ECE 612
//Real Time Embedded Sysems
...
int main(int argc, char* argv[])
{
	...
	std::uniform_int_distribution<int> uni(0, 4); // guarantees unbiased

	// sets random speed to the lead car
	// sets the speed of the follower car to the speed of the lead car
